...
# Legacy BASH version <=3(out-of-box bash on Mac) doesn't have nosort option.
# Note that nosort has no effect for zsh.
[[ "$BASH_VERSINFO" -ge 4 ]] && comp_options="-o default -o nosort" || comp_options="-o default"
complete -F _atest $comp_options atest
