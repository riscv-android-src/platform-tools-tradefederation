...
public class ModuleSplitterTest {
    ...
    /**
     * Tests that {@link ModuleSplitter#splitConfiguration(LinkedHashMap, int)} on a non shardable
     * configuration results in a matching ModuleDefinition to be created with the same objects.
     */
    @Test
    public void testSplitModule_configNotShardable() throws Exception {
        ...
        List<ModuleDefinition> res = ModuleSplitter.splitConfiguration(runConfig, 5);
    ...
    /**
     * Tests that {@link ModuleSplitter#splitConfiguration(LinkedHashMap, int)} on a non shardable
     * test results in a matching ModuleDefinition created with the original IRemoteTest and copied
     * ITargetPreparers.
     */
    @Test
    ...
    /**
     * Tests that {@link ModuleSplitter#splitConfiguration(LinkedHashMap, int)} on a shardable test
     * but did not shard (for any reasons) results in a ModuleDefition with original IRemoteTest and
     * copied ITargetPreparers.
     */
    @Test
    ...
    /**
     * Tests that {@link ModuleSplitter#splitConfiguration(LinkedHashMap, int)} on a shardable test
     * that shards results in one ModuleDefinition per IRemoteTest generated by the test.
     */
    @Test
    public void testSplitModule_testShardable_shard() throws Exception {
        ...
        // allow StubTest to shard in 5 sub tests
